...
Change desired parameters in config dictionary in 'run_reg_vaes.py' and specify desired model. Then run:
'''
$ python run_reg_vaes.py
'''
### For VAE-GAN
Again, change desired parameters in config dictionary in 'run_vaegan.py' and run: 
'''
python run_vaegan.py
'''
